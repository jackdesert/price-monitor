...
class StatsPresenterOriginal:
    # This was the original StatsPresenter
    # But it performed slow on cheap hardward after we had
    # Three months of data.
    # This has been superseded by StatsPresenter
